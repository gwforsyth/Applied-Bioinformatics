...
.doDE <- function(eset)
{
  ...
  nrow(topTable(ebFit, coef=1, number=10000, lfc=5))
  nrow(topTable(ebFit, coef=1, number=10000, lfc=4))
  nrow(topTable(ebFit, coef=1, number=10000, lfc=3))
  nrow(topTable(ebFit, coef=1, number=10000, lfc=2))
