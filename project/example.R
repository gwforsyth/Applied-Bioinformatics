...
.getData <- function()
{
	...
	filenames <- c("ROS1+_10.CEL", "ROS1-_9.CEL", "ROS2+_12.CEL", 
                "ROS2-_11.CEL", "ROS3+_14.CEL", "ROS3-_13.CEL",
              "ROS4+_16.CEL", "ROS4-_15.CEL")
	samplenames <- c("ROS1+_10", "ROS1-_9", "ROS2+_12", 
	                 "ROS2-_11", "ROS3+_14", "ROS3-_13",
	                 "ROS4+_16", "ROS4-_15")
